...
function validate(formularz) {
    if (!checkStringAndFocus(formularz.elements["f_imie"], "Podaj imię!", isWhiteSpaceOrEmpty)) {
        ...
        return false
    } else if (!checkStringAndFocus(formularz.elements["f_kod"], "Podaj kod!", isWhiteSpaceOrEmpty)) {
        return false
    } else if (!checkStringAndFocus(formularz.elements["f_ulica"], "Podaj ulicę!", isWhiteSpaceOrEmpty)) {
        return false
    } else if (!checkStringAndFocus(formularz.elements["f_miasto"], "Podaj miasto!", isWhiteSpaceOrEmpty)) {
        return false
    } else if (!checkStringAndFocus(formularz.elements["f_email"], "Podaj email", isEmailInvalid)) {
        return false
    } else {
        return true
    }
